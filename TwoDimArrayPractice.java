...
public class TwoDimArrayPractice extends JFrame
{
   ...
   */
   public void setValues( int value, int row )
   {
    ...
    // Write your code here:
	   ...
	   //for loop until you get to the row
	   //second for loop of the columns to change 
	   for (int row2 =0; row2 < intArray.length; row2++) {
		   if (row2 == row)
		   {
			  for (int column = 0; column <intArray[row].length; column++) {
				  intArray[row2] [column] = value;
				  animate( row2, column );
			  }  
		   }
	   }
   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
	   int min= 1000;
	   for (int row3= 0; row3 < intArray.length; row3++) {
		   for (int column2 = 0; column2 <intArray[row3].length; column2++) {
			   if (column2 == column) {
				   if (intArray[row3] [column2] < min) {
					   min= intArray [row3] [column2]; //changes min to the new smallest value
				   }
			   }
			   animate( row3, column2, min );
		   }
	   }
   ...
   */
   public int countFound( int value )
   {
    ...
    // Write your code here:
	   int repeat =0; 
	   for (int row4 = 0; row4 < intArray.length; row4++) {
		   for (int column3 = 0; column3 < intArray[row4].length; column3++) {
			   if (intArray[row4] [column3] == value) {
				   repeat++;
			   }
			   animate( row4, column3, repeat);
		   }
	   }
	   
	   
     return repeat; // replace this line with your return statement
   }
